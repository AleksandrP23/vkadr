...
/* harmony import */ var tingle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
...
var mailConf = {
  mailSendHost: "smtp.yandex.ru",
  mailSendUsername: "amo@vcadre.ru",
  mailSendPassword: "amogfh0km",
  mailSendTo: 'amo@vcadre.ru',
  mailSendFrom: "amo@vcadre.ru"
}; // === Helpers

function maskPhone(selector) {
  var masked = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '+_(___)_________';
...
document.addEventListener('DOMContentLoaded', function () {
  var utms = {}; // Parse the URL

  function getParameterByName(name) {
    var nameString = name.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
    var regex = new RegExp("[\\?&]" + nameString + "=([^&#]*)");
  ...
  var utmPmSource = getParameterByName('pm_source');
  var utmPmBlock = getParameterByName('pm_block');
  var utmPmPosition = getParameterByName('pm_position');
  ...
  if (utmPmSource) {
    utms['pm_source'] = utmPmSource;
  }

  if (utmPmBlock) {
    utms['pm_block'] = utmPmBlock;
  }

  if (utmPmPosition) {
    utms['pm_position'] = utmPmPosition;
  } // Calls funcs


  maskPhone('.js-phone-mask'); // === Forms

  var loader = document.querySelector('.page-loader');

  function sendEmail() {
    var formName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Обратный звонок';
    ...
    var who = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : ' - ';
    var utmTags = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : utms;
    loader.classList.add('show');
    Email.send({
      Host: mailConf.mailSendHost,
      Username: mailConf.mailSendUsername,
      Password: mailConf.mailSendPassword,
      To: mailConf.mailSendTo,
      From: mailConf.mailSendFrom,
      Subject: "\u0417\u0430\u044F\u0432\u043A\u0430 \u0441 \u0441\u0430\u0439\u0442\u0430 vcadre.ru",
      Body: "\n\t\t\t\t<table border=\"1\" style=\"border-collapse: collapse; empty-cells: show; width: 100%; font-family: Arial, sans-serif;\">\n\t\t\t\t<thead>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<th style=\"padding: 15px 30px; font-weight: 700; font-size: 28px;\" scope=\"col\" colspan=\"2\">\u0417\u0430\u044F\u0432\u043A\u0430 \u0441 \u0441\u0430\u0439\u0442\u0430 vcadre.ru</th>\n\t\t\t\t\t</tr>\n\t\t\t\t</thead>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>\u0424\u043E\u0440\u043C\u0430</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">".concat(formName || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>\u0418\u043C\u044F</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(name || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px\"><strong>\u0422\u0435\u043B\u0435\u0444\u043E\u043D</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(phone || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>Email</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\">").concat(email || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>\u041A\u0442\u043E \u0432\u0430\u043C \u043D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C?</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\">").concat(who || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>utm_source</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(utmTags.utm_source || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px\"><strong>utm_medium</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(utmTags.utm_medium || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>utm_campaign</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\">").concat(utmTags.utm_campaign || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px\"><strong>utm_content</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(utmTags.utm_content || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>utm_term</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\">").concat(utmTags.utm_term || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t")
    }).then(function () {
  ...
  var ajaxPost = function ajaxPost(cls, classError, func) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(cls).on('submit', function (e) {
      e.preventDefault();
      ...
      $this.find('.js-validate-text').each(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().removeClass(classError);
        var re = /^[a-zA-Zа-яА-ЯЁё ]+$/;
        var isText = re.test(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());

        if (!isText) {
          jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().addClass(classError);
          error += 1;
        }
      });
      $this.find('.js-validate-email').each(function () {
        ...
        var isEmail = reEmail.test(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
      ...
      $this.find('.js-validate-phone').each(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent().removeClass(classError);
        var rePhone = /^[\s()+-]*([0-9][\s()+-]*){6,20}$/;
        var isPhone = rePhone.test(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val());
      ...
      if (error === 0) {
        ...
        var formName = formData.formName,
            ...
            who = formData.who;
        sendEmail(formName, name, phone, email, who);*/
        if (typeof utms === 'object') {
          for (var utmKey in utms) {
            if (utms.hasOwnProperty(utmKey)) {
              values.push({ name: utmKey, value: utms[utmKey] });
            }
          }
        }
        
        values.push({ name: 'is_ajax', value: true });
        jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
          ...
          success: function (data) {
            if ((typeof data !== 'undefined') && data.status && (data.status === 'ok'))
            {
              loader.classList.remove('show');
              window.location.href = '/spasibo/';
            }
        ...
        setTimeout(function () {
          $this.find('.field').removeClass(classError);
        }, 4000);
      }
  ...
  ajaxPost('.js-validate-form', 'error', function () {
    return false;
  }); // === Modals
  ...
  var modalPolitic = new tingle_js__WEBPACK_IMPORTED_MODULE_2___default.a.modal({
    footer: false,
    stickyFooter: false,
    cssClass: ['modal-politic'],
    closeMethods: ['overlay', 'button', 'escape'],
    onOpen: function onOpen() {
      var close = this.modalCloseBtn;
      var box = this.modalBox;
  ...
  /* Удалил повторное открытие всплывающих окон */
  var callbackBtns = []; //document.querySelectorAll('.js-show-callback');
  var politicsBtn = null; //document.querySelector('.js-politics-show');

  if (politicsBtn) {
    politicsBtn.addEventListener('click', function (e) {
      e.preventDefault();
      var content = document.querySelector('.politics-modal').innerHTML;
      modalPolitic.setContent(content);
      modalPolitic.open();
    });
  }

  if (callbackBtns && callbackBtns.length > 0) {
    callbackBtns.forEach(function (item) {
      item.addEventListener('click', function (e) {
        e.preventDefault();
        console.log(this.dataset);
        var isConsult = this.dataset.hasOwnProperty('consult');
        var isCallback = this.dataset.hasOwnProperty('callback');
        var isEmployees = this.dataset.hasOwnProperty('employees');

        if (isConsult) {
          modal.setContent(document.querySelector('.modals .consult').innerHTML);
        }

        if (isEmployees) {
          modal.setContent(document.querySelector('.modals .employees').innerHTML);
        }

        if (isCallback) {
          modal.setContent(document.querySelector('.modals .callback').innerHTML);
        }
  ...
  var lettersCarousel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.letters__carousel');

  if (lettersCarousel) {
    lettersCarousel.slick({
      dots: true,
      arrows: true,
      infinite: true,
      speed: 300,
  ...
  var certsCarousel = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.certs__carousel');
  ...
  var photos = document.querySelectorAll('.spotlight');
  var showMorePhotos = document.querySelector('.show-more');

  if (photos && photos.length > 0 && showMorePhotos) {
    showMorePhotos.addEventListener('click', function () {
      photos.forEach(function (element) {
        if (element.classList.contains('spotlight-hidden')) {
          element.classList.remove('spotlight-hidden');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.animate').parent().each(function () {
    var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
  /* harmony import */
  ...
  var slick_carousel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
  /* harmony import */
  ...
  var tingle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
  /* harmony import */


  var tingle_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(tingle_js__WEBPACK_IMPORTED_MODULE_2__);
  /* harmony import */


  var _configMailSend__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function sendEmail() {
      ...
      loader.classList.add('show');
      Email.send({
        Host: _configMailSend__WEBPACK_IMPORTED_MODULE_3__["mailConf"].mailSendHost,
        Username: _configMailSend__WEBPACK_IMPORTED_MODULE_3__["mailConf"].mailSendUsername,
        Password: _configMailSend__WEBPACK_IMPORTED_MODULE_3__["mailConf"].mailSendPassword,
        To: _configMailSend__WEBPACK_IMPORTED_MODULE_3__["mailConf"].mailSendTo,
        From: _configMailSend__WEBPACK_IMPORTED_MODULE_3__["mailConf"].mailSendFrom,
        Subject: "\u0417\u0430\u044F\u0432\u043A\u0430 \u0441 \u0441\u0430\u0439\u0442\u0430 vcadre.ru",
        Body: "\n\t\t\t\t<table border=\"1\" style=\"border-collapse: collapse; empty-cells: show; width: 100%; font-family: Arial, sans-serif;\">\n\t\t\t\t<thead>\n\t\t\t\t\t<tr>\n\t\t\t\t\t\t<th style=\"padding: 15px 30px; font-weight: 700; font-size: 28px;\" scope=\"col\" colspan=\"2\">\u0417\u0430\u044F\u0432\u043A\u0430 \u0441 \u0441\u0430\u0439\u0442\u0430 vcadre.ru</th>\n\t\t\t\t\t</tr>\n\t\t\t\t</thead>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>\u0424\u043E\u0440\u043C\u0430</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">".concat(formName || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>\u0418\u043C\u044F</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(name || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px\"><strong>\u0422\u0435\u043B\u0435\u0444\u043E\u043D</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(phone || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>Email</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\">").concat(email || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>\u041A\u0442\u043E \u0432\u0430\u043C \u043D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C?</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\">").concat(who || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>utm_source</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(utmTags.utm_source || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px\"><strong>utm_medium</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(utmTags.utm_medium || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>utm_campaign</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\">").concat(utmTags.utm_campaign || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr style=\"background-color: #e5e5e5;\">\n\t\t\t\t\t<td style=\"padding: 15px 30px\"><strong>utm_content</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px\">").concat(utmTags.utm_content || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t\t<tr>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\"><strong>utm_term</strong></td>\n\t\t\t\t\t<td style=\"padding: 15px 30px;\">").concat(utmTags.utm_term || ' - ', "</td>\n\t\t\t\t</tr>\n\t\t\t</table>\n\t\t\t")
      }).then(function () {
        loader.classList.remove('show');
    ...
    var callbackBtns = document.querySelectorAll('.js-show-callback');
    var politicsBtn = document.querySelector('.js-politics-show');
    var onlineMeetBtn = document.querySelector('.js-modal-online-meet-show');


    if (onlineMeetBtn) {
      onlineMeetBtn.addEventListener('click', function (e) {
        e.preventDefault();
        var content = document.querySelector('.online-meet-modal').innerHTML;
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  __webpack_require__.d(__webpack_exports__, "mailConf", function () {
    return mailConf;
  });
    ...
    grunt.initConfig({
      ...
      jasmine: {
        full: {
          ...
          options: {
            specs: "spec/*[S|s]pec.js",
            vendor: ["spec/lib/matchers.js", "spec/lib/jasmine-species/jasmine-grammar.js", "spec/lib/setup.js", "lib/jquery-1.9.0.min.js", "spec/lib/jquery.keymasher.js"]
          }
        }
      },
      nugetpack: {
